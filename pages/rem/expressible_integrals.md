We have said that there is no set of rules that work for every function. Indeed it is much more subtle than that. There are functions whose integral *is not expressible in terms of elementary functions*:
